...
parser.add_argument( "--model_type", type = str, default = "ENB1", help = "Choosing the model to be used for training. Options: SaN, MN2, IC3, ENB1." )
...
if __name__ == '__main__':
  ...
  for fold_index in range( 0, NUMBER_OF_FOLDS ):
    ...
    model = None
    if CUSTOM_MODEL_TYPE == 'SaN':
      model = model_creator.sketchANet( IMAGE_HEIGHT, IMAGE_WIDTH, CUSTOM_NUMBER_OF_CLASSES, CUSTOM_OUTPUT_ACTIVATION_FUNCTION )
